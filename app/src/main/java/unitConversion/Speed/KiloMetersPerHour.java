...
public class KiloMetersPerHour extends Unit implements Speed {
    ...
    public BigDecimal convertSpeed(FeetPerSecond feetPerSecond) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 0.9113444154);
    }
    ...
    public BigDecimal convertSpeed(MetersPerSecond metersPerSecond) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 0.2777777778);
    }
    ...
    public BigDecimal convertSpeed(MilesPerHour milesPerHour) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 0.6213711923);
    }
    ...
    public BigDecimal convertSpeed(MilesPerSecond milesPerSecond) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 0.000172603109);
    }
