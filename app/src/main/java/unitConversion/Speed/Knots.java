...
public class Knots extends Unit implements Speed {
    ...
    public BigDecimal convertSpeed(FeetPerSecond feetPerSecond) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 1.687809857);
    }
    ...
    public BigDecimal convertSpeed(KiloMetersPerSeconds kiloMetersPerSeconds) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 0.0005144444444);
    }
    ...
    public BigDecimal convertSpeed(MetersPerSecond metersPerSecond) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 0.5144444444);
    }
    ...
    public BigDecimal convertSpeed(MilesPerSecond milesPerSecond) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 0.0003196609578);
    }
