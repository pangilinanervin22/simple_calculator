...
public class MilesPerHour extends Unit implements Speed {
    ...
    public MilesPerHour() {setUnitSymbol("mi/s");
    }
    ...
    public BigDecimal convertSpeed(FeetPerSecond feetPerSecond) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 1.466666667);
    }
    ...
    public BigDecimal convertSpeed(KiloMetersPerSeconds kiloMetersPerSeconds) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 0.00044704);
    }
    ...
    public BigDecimal convertSpeed(MetersPerSecond metersPerSecond) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 0.44704);
    }
