...
public class Pounds extends Unit implements Mass {
    ...
    public BigDecimal convertMass(Miligrams miligrams) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 453592.37);
    }
    ...
    public BigDecimal convertMass(Grams grams) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 453.59237);
    }
    ...
    public BigDecimal convertMass(Kilograms kilograms) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 0.45359237);
    }
    ...
    public BigDecimal convertMass(Tons tons) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 0.0005);
    }
    ...
    public BigDecimal convertMass(MetricTons metricTons) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 0.00045359237);
    }
    ...
    public BigDecimal convertMass(Stones stones) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 0.07142857143);
    }
