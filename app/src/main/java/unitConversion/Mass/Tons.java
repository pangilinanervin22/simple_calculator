...
public class Tons extends Unit implements Mass {
    ...
    public BigDecimal convertMass(Miligrams miligrams) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 907184740);
    }
    ...
    public BigDecimal convertMass(Grams grams) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 907184.74);
    }
    ...
    public BigDecimal convertMass(Kilograms kilograms) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 907.18474);
    }
    ...
    public BigDecimal convertMass(MetricTons metricTons) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 0.90718474);
    }
    ...
    public BigDecimal convertMass(Ounces ounces) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 32000);
    }
    ...
    public BigDecimal convertMass(Pounds pounds) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 2000);
    }
    ...
    public BigDecimal convertMass(Stones stones) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 142.8571429);
    }
