...
public class CubicMeters extends Unit implements Volume {
    ...
    public CubicMeters() {setUnitSymbol("m³");
    }
    ...
    public BigDecimal convertVolume(CubicFoot cubicFeet) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 35.31466672);
    }
    ...
    public BigDecimal convertVolume(Cups cups) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 4226.752838);
    }
    ...
    public BigDecimal convertVolume(FluidOunces fluidOunces) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 33814.0227);
    }
    ...
    public BigDecimal convertVolume(Gallons gallons) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 264.1720524);
    }
