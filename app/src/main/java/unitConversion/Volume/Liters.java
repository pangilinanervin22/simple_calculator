...
public class Liters extends Unit implements Volume {
    @Override
    public String toString() {
        return "Liters (L)";
    }

    public Liters() {setUnitSymbol("L");
    }
    ...
    public BigDecimal convertVolume(CubicFoot cubicFeet) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 0.03531466672);
    }
    ...
    public BigDecimal convertVolume(Cups cups) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 4.226752838);
    }
    ...
    public BigDecimal convertVolume(FluidOunces fluidOunces) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 33.8140227);
    }
    ...
    public BigDecimal convertVolume(Gallons gallons) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 0.2641720524);
    }
