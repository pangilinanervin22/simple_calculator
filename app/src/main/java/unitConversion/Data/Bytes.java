...
public class Bytes extends Unit implements Data{
    ...
    public BigDecimal convertData(Gigabytes gigabytes) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 0.000000001);
    }
    ...
    public BigDecimal convertData(Terabytes terabytes) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 0.000000000001);
    }
    ...
    public BigDecimal convertData(Petabytes petabytes) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 0.000000000000001);
    }
