...
public class Milliseconds extends Unit implements Time{
    ...
    public BigDecimal convertTime(Minutes minutes) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 1.6667e-5);
    }
    ...
    public BigDecimal convertTime(Hours hours) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 2.7778e-7);
    }
    ...
    public BigDecimal convertTime(Days days) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 1.1574e-8);
    }
    ...
    public BigDecimal convertTime(Weeks weeks) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 1.6534e-9);
    }
    ...
    public BigDecimal convertTime(Months months) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 3.8052e-10);
    }
    ...
    public BigDecimal convertTime(Years years) {
        ...
        return BigDecimal.valueOf(Double.parseDouble(getValue()) * 3.171e-11);
    }
